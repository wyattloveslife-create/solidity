...
struct FuzzerUtil
{
	...
	/// (off otherwise). Always targets the current EVM version.
	/// @param _forceSMT if true, adds the experimental SMTChecker pragma to
	/// each source file in the source map.
